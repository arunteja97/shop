...
const Product = ({product}) => {
    ...
    return (
        ...
        <Card
            sx={{ height: '100%', display: 'flex', flexDirection: 'column', textAlign: 'left'}}
        >
            <CardMedia
            component="div"
            sx={{
            ...
            <Typography gutterBottom component="h2" variant="body2" color="text.secondary">
                {`Rs. ${price}`}
            </Typography>
            <Typography>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla dapibus elit eget lorem placerat, ac pellentesque libero ultrices.
            </Typography>
            </CardContent>
            <Divider/>
            <CardActions>
